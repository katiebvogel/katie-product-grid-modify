...
Template.myProducts.replaces("products");

Template.myProducts.inheritsHelpersFrom("products");
Template.myProducts.inheritsEventsFrom("products");
Template.myProducts.inheritsHooksFrom("products");
